...
Doc.prototype = {
    ...
    markdown: function(text) {
        ...
        text = text.replace(/<h2>/g, "</section>\n<section>\n<h2>");
        text = text.replace(/<li>/g, "<li class='fragment'>");

        text = text.replace(/<ul>\n<li class='fragment'/g, "<ul>\n<li");
        text = text.replace(/<ol>\n<li class='fragment'/g, "<ol>\n<li");
        ...
        if (self.methods.length) {
            dom.div({class: 'member method'}, function() {
                dom.h('Methods', self.methods, function(method) {
                    ...
                    var signature = (method.param || []).filter(function(e) {
                        return e.isProperty !== true;
                    }).map(property('name'));
